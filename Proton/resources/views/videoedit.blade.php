...
<head>
  ...
  <body>
      ...
      <h5>
        <a class="" href="/videoadmin" style="color:black"><i class="fas fa-sign-out-alt mr-3"></i></a>
      </h5>
      </div>
      </nav>
<body>
<div class="col-md-10 p-5 pt-2 mt-5">
      <h3><i class="fas fa-video mr-2"></i></i> Edit Video</h3><hr>

<div class="container">

    @foreach($edit as $e)
    <form action="{{ url('videoupdate') }}" method="POST">
    {{ @csrf_field() }}
    <h3>Edit Link</h3>
